...
Функционал: Проверка ввода количества для услуги в заказе

Как Менеджер по закупкам я хочу
проверить в заказе возможность ввода количества для услуги 
чтобы получить ответ, возможно ли это

Контекст:
Дано Я открыл новый сеанс TestClient или подключил уже существующий

Сценарий:  Проверка ввода количества для услуги в заказе
